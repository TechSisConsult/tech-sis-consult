...
export async function POST(req: Request) {
  try {
    ...
    await resend.emails.send({
      from: 'TechSisConsult Website <hello@techsisconsult.com>',
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .value { font-size: 15px; font-weight: 600; color: #003049; margin-bottom: 20px; }
              .badge { display: inline-block; background: #d4a843; color: #003049; font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; padding: 4px 12px; border-radius: 999px; margin-bottom: 24px; }
              .divider { height: 1px; background: #f3f4f6; margin: 20px 0; }
              .footer { font-size: 12px; color: #9ca3af; text-align: center; margin-top: 24px; }
              h2 { color: #003049; font-size: 22px; margin: 0 0 8px; }
              .reply-tip { background: #fffbf0; border: 1px solid #d4a84340; border-radius: 12px; padding: 16px; margin-top: 24px; font-size: 13px; color: #003049; line-height: 1.6; }
            </style>
          </head>
          <body>
            <section class="card">
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .header { background: #003049; border-radius: 12px; padding: 24px; text-align: center; margin-bottom: 28px; }
              h1 { color: #d4a843; font-size: 22px; margin: 0 0 8px; }
              .sub { color: rgba(255,255,255,0.6); font-size: 13px; margin: 0; }
              h2 { color: #003049; font-size: 18px; }
              p { color: #6b7280; font-size: 14px; line-height: 1.7; }
              .step { display: flex; gap: 12px; align-items: flex-start; margin-bottom: 14px; }
              .dot { width: 24px; height: 24px; border-radius: 50%; background: #d4a843; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 800; color: #003049; flex-shrink: 0; margin-top: 2px; }
              ...
              .cta { display: inline-block; background: #d4a843; color: #003049; font-weight: 800; font-size: 14px; padding: 12px 28px; border-radius: 999px; text-decoration: none; margin: 16px 0; }
            </style>
          </head>
          <body>
            <section class="card">
              ...
              <p>
                ...
                <strong style="color: #003049;">Within the next few hours</strong>, 
                we'll send you a confirmed time slot and a Google Meet link.
              </p>

              <p><strong style="color: #003049;">What happens next:</strong></p>
