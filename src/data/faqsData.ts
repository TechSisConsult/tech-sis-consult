export const FAQS = [
  {
    question: 'My business already gets referrals. Why do I need a website?',
    answer:
      'Referrals are valuable, but many potential customers will still search for you online before making a decision. A professional website helps build trust, showcase your services, and ensure people can find and contact you anytime.',
  },
...

  {
    ...
    answer:
      'If your website is outdated, slow, difficult to use, or not generating results, a redesign can improve user experience, credibility, and conversion rates.',
  },

  {
    question: 'How do I know if my website is costing me customers?',
    answer:
      'Signs include poor mobile experience, slow loading times, outdated design, low enquiries, and difficulty finding information. These issues often cause visitors to leave and choose competitors instead.',
  },
...

  {
    ...
    answer:
      'Absolutely. We build e-commerce stores that allow customers to browse products, make secure payments, and place orders online from anywhere.',
  },

  {
    question: 'Will my website work properly on mobile devices?',
    answer:
      'Yes. Every website we build is fully responsive and optimized for mobile phones, tablets, and desktop computers.',
  },

  {
    question: 'Can visitors contact me directly through the website?',
    answer:
      'Yes. We can integrate contact forms, WhatsApp chat, booking systems, and other lead-generation tools that make it easy for potential customers to reach you.',
  },

  {
    question: 'Will my website appear on Google?',
    answer:
      'Yes. We implement SEO best practices and search engine indexing to give your website a strong foundation for visibility on Google and other search engines.',
  },
...

  {
    ...
    answer:
      'Yes. We provide post-launch support and also offer ongoing website care plans for businesses that want continuous maintenance and technical assistance.',
  },
...

  {
    ...
    answer:
      'We offer a free consultation where we discuss your goals and recommend the solution that provides the best value for your business.',
  },
];
