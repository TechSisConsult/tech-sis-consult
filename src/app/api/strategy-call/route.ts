        ...
        <html>
          <head>
            ...
            <style>
              ...
              .badge { display: inline-block; background: #f7bb3b; color: #021823; font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.1em; padding: 4px 12px; border-radius: 999px; margin-bottom: 24px; }
              ...
              .reply-tip { background: #fffbf0; border: 1px solid #f7bb3b40; border-radius: 12px; padding: 16px; margin-top: 24px; font-size: 13px; color: #021823; line-height: 1.6; }
            </style>
          </head>
          <body>
            <section class="card">
              ...
              <div class="value"><a href="mailto:${email}" style="color: #f7bb3b;">${email}</a></div>
        ...
        <html>
          <head>
            ...
            <style>
              ...
              h1 { color: #f7bb3b; font-size: 22px; margin: 0 0 8px; }
              ...
              .dot { width: 24px; height: 24px; border-radius: 50%; background: #f7bb3b; display: flex; align-items: center; justify-content: center; font-size: 10px; font-weight: 800; color: #021823; flex-shrink: 0; margin-top: 2px; }
              ...
              .cta { display: inline-block; background: #f7bb3b; color: #021823; font-weight: 800; font-size: 14px; padding: 12px 28px; border-radius: 999px; text-decoration: none; margin: 16px 0; }
            </style>
          </head>
          <body>
            <section class="card">
