        ...
        <div ref={linksRef} className="grid sm:grid-cols-3 gap-4 mb-4">
          {QUICK_LINKS.map((l, i) => (
            ...
            >
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-[#021823]/6 group-hover:bg-[#021823] text-[#021823] group-hover:text-[#f7bb3b] flex items-center justify-center transition-all duration-300 flex-shrink-0">
                  {l.icon}
                </div>
                <span className="text-[#021823] font-bold text-sm group-hover:text-[#f7bb3b] transition-colors duration-200">
                  {l.label}
                </span>
                <svg
                  className="w-4 h-4 text-gray-300 group-hover:text-[#f7bb3b] ml-auto transition-all duration-200 group-hover:translate-x-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2.5}
        ...
        >
          ...
          <div className="relative z-10 max-w-lg text-center lg:text-left flex flex-col gap-3">
            ...
            <h2 className="text-3xl xl:text-4xl font-extrabold text-white leading-tight">
              Let&apos;s Have a{' '}
              <span className="text-[#f7bb3b]">Real Conversation</span>
            </h2>
          ...
          <div className="relative z-10 flex flex-col gap-3 flex-shrink-0">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-white/20 hover:border-[#f7bb3b] text-white hover:text-[#f7bb3b] font-semibold px-8 py-4 rounded-t-xl rounded-r-xl text-sm transition-all duration-200 whitespace-nowrap"
            >
              Send Us an Email
            </Link>
          </div>
